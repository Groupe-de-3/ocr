...
/*! \brief Uses #hough_acc_space_run_at and goes through the image to create the hough space. Also also normalizes theses values.
 *
 * \param in the sudoku image.
 * \param gradient_dir image as a matrice giving the gradient direction.
 * \param out the hough space.
...
/*! \brief Another way to create the hough space by going through random coordinates
 *
