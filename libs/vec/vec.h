 ...
 *  \returns Vector to the removed element, should be considered invalid after any call to another vec function.
 */
 ...
 *  
 *  The given pointer should be a pointer to a Vec created with #vec_create or #vec_new.
 *  This pointer may be changed if an allocation was required.
 * 
